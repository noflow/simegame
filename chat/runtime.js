...
function ensureModal(){
  ...
  if (!modal){
    ...
    modal.innerHTML = [
      ...
      '.cosmosrp-log{flex:1 1 auto;min-height:0;height:0;max-height:100%;overflow:auto;display:flex;flex-direction:column;gap:10px;background:#0d0f13;border:1px solid #1b222b;border-radius:12px;padding:12px;overscroll-behavior:contain;scrollbar-gutter:stable both-edges}',
