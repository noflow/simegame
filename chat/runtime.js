...
function ensureModal(){
  ...
  if (!modal){
    ...
    modal.innerHTML = [
      ...
      '.cosmosrp-card{width:min(1100px,96vw);height:75vh;max-height:90vh;border:1px solid #1b222b;border-radius:14px;overflow:hidden;background:#0d0f13;color:#dfe6f1;display:flex;flex-direction:column;min-height:0}',
      ...
      '.cosmosrp-body{display:flex;gap:10px;padding:12px;min-height:420px;flex:1 1 auto;overflow:hidden}',
