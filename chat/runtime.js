// Chat runtime (v26) — full modal (#chatModal), ES modules ok in modern browsers
if (window.__CHAT_RUNTIME_LOADED__) {
  ...
  if (typeof window.ensureModal !== 'function') {
    function ensureModal(){
      ...
      // Size/layout largely controlled by page CSS; just ensure base structure exists
      modal.innerHTML = [
        ...
        '  <div class="cosmosrp-card" style="width:min(860px,96vw);max-height:90vh;border:1px solid #1b222b;border-radius:14px;overflow:hidden;background:var(--panel)">',
        ...
        '    </div>',
        '    <div class="cosmosrp-body" style="display:flex;gap:10px;padding:12px;min-height:360px">',
  ...
  // --- renderChat fallback (allows game to call it) ---
  ...
  function startChat(npcOrId){
    try{
      ...
      } else if (typeof window.currentNpcId !== 'string') {
