// Chat module (dynamic router import, guarded)
...
if (window.__CHAT_MODULE_LOADED__) {
  ...
  console.log("✅ Loaded chat module from:", (typeof import !== 'undefined' && typeof import.meta !== 'undefined') ? import.meta.url : (document.currentScript && document.currentScript.src));

  // Lazy-load the router once and cache it
  ...
  function getRespond(){
    ...
    if (!__routerPromise) {
      try {
        ...
        __routerPromise = Promise.reject(e);
      }
    }
